...
module datapath (
    ...
    input         Jalr,
    output        Zero, ALUR31, LessThanSigned, LessThanUnsigned,
    output [31:0] PC,
    input  [31:0] Instr,
...
imm_extend     ext (Instr, ImmSrc, ImmExt);// [31:7]

// ALU logic
mux2 #(32)     srcbmux(WriteData, ImmExt, ALUSrc, SrcB);
alu            alu (SrcA, SrcB, ALUControl, ALUResult, Zero, LessThanSigned, LessThanUnsigned);
