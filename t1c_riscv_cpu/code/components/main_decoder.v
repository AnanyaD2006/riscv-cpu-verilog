...
module main_decoder (
    input  [6:0] op,
    input  [2:0] funct3,
    input        Zero, ALUR31,LessThanSigned, LessThanUnsigned,
        ...
        7'b1100011: begin  // branch
            ...
            case (funct3)
               ...
               3'b001: TakeBranch =   !Zero;
			    3'b100: TakeBranch =  LessThanSigned;
               3'b101: TakeBranch = !LessThanSigned;
				3'b110: TakeBranch = LessThanUnsigned;
				3'b111: TakeBranch = !LessThanUnsigned;
            endcase
        end
